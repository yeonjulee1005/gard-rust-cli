...
impl Default for GeneralConfig {
    fn default() -> Self {
        Self { version: "1".into(), author: String::new(), sign_commits: true }
    }
}
...
impl Default for ProtectionConfig {
    fn default() -> Self {
        Self { pre_push_scan: true, block_on_critical: true, block_unsigned_push: false }
    }
}
...
impl Default for Tier3Config {
    fn default() -> Self {
        Self { max_file_size_kb: 100, skip_minified: true, obfuscation_block_score: 80 }
    }
}
...
impl Default for ReportConfig {
    fn default() -> Self {
        Self { format: ReportFormat::Terminal, show_suggestions: true }
    }
}
...
impl Default for HooksConfig {
    fn default() -> Self {
        Self { pre_commit: false, post_commit: true, pre_push: true }
    }
}
